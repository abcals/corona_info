...
public class CoronaInfoComponent {
    ...
    public void getCoronaAgeInfo() throws Exception{
        ...
        StringBuilder urlBuilder = new StringBuilder("http://openapi.data.go.kr/openapi/service/rest/Covid19/getCovid19GenAgeCaseInfJson");
        ...
        for(int i=0; i<nList.getLength(); i++){
            ...
            else if(gubun.equals("남성")) gubun = "남성";
    ...
    public void getCoronaVaccineInfo()throws Exception{
        ...
        String today = dtFormatter.format(dt)+"00:00:00";
        ...
        urlBuilder.append("&" + URLEncoder.encode("cond[baseDate::EQ]","UTF-8") + "=" + URLEncoder.encode(today, "UTF-8"));
        System.out.println(urlBuilder.toString());
        ...
        for(int i=0; i<dataArray.length(); i++){
            ...
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date sDt = formatter.parse(baseDate);
